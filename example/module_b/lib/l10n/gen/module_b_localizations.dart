...
abstract class ModuleBLocalizations {
  ModuleBLocalizations(String locale)
    : localeName = intl.Intl.canonicalizedLocale(locale.toString());

  final String localeName;

  static ModuleBLocalizations of(BuildContext context) {
    return Localizations.of<ModuleBLocalizations>(
      context,
...
class _ModuleBLocalizationsDelegate
  ...
  Future<ModuleBLocalizations> load(Locale locale) {
    return SynchronousFuture<ModuleBLocalizations>(
      lookupModuleBLocalizations(locale),
    );
  }
