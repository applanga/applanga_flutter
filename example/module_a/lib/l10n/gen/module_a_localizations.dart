...
class _ModuleALocalizationsDelegate
  ...
  Future<ModuleALocalizations> load(Locale locale) {
    return SynchronousFuture<ModuleALocalizations>(
      lookupModuleALocalizations(locale),
    );
  }
