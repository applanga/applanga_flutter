...
""";
  ...
  void parseL10n() {
    ...
    final syntheticPackageActivated = (syntheticPackage != null &&
        syntheticPackage is bool &&
        syntheticPackage == true);

    if (syntheticPackageActivated ||
        !_doesDirectoryExist(_flutterAutoGeneratedOutputDir)) {
      _flutterAutoGeneratedOutputDir = ".dart_tool/flutter_gen/gen_l10n";
      if (!_doesDirectoryExist(_flutterAutoGeneratedOutputDir)) {
        throw ApplangaConfigException(
            "Could not find generated localization files. Make sure to run `flutter gen-l10n` first.");
      }
      Utils.writeLn(
          "Using synthetic package for generated localizations. Consider migrating away foom synthetic package as it is deprecated by Flutter.");
  ...
  bool _doesDirectoryExist(String dirPath) =>
      Directory(path.join(_rootDirPath, dirPath)).existsSync();
