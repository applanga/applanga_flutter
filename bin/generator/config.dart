...
class ApplangaConfig {
  ...
  String get destinationClassFileName {
    final regex = RegExp(r'(?<!^)([A-Z])');
    final result = className.replaceAllMapped(
        regex, (match) => '_${match.group(1)!.toLowerCase()}');
    return '${result[0].toLowerCase()}${result.substring(1)}.dart';
  }

  String _className = 'ApplangaLocalizations';
  String _appLocalizationsClassName = 'AppLocalizations';

  String get className => _className;

  String get appLocalizationsClassName => _appLocalizationsClassName;
  ...
  bool get getDynamicStrings => _getDynamicStrings;
  ...
  String get destinationAppLocalizationsClassPath =>
      path.join(_rootDirPath, _destinationPath, destinationClassFileName);
...
""";
  ...
  void parsePubspec() {
    ...
    var getDynamicStrings = applangaConfig["get_dynamic_strings"];
    if (getDynamicStrings is bool) {
  ...
  void parseL10n() {
    ...
    var outputClass = l10nYaml['output-class'];
    ...
    if (syntheticPackage != null &&
      ...
      if (outputDir != null && outputDir is String) {
        // using custom output dir
        _flutterAutoGeneratedOutputDir = outputDir;
      } else {
        // default output dir
        _flutterAutoGeneratedOutputDir = _arbDir;
      }
    ...
    if (outputClass != null && outputClass is String) {
      _appLocalizationsClassName = outputClass;
      _className = "Applanga$_appLocalizationsClassName";
    }
