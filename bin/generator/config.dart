...
""";
  ...
  void parseL10n() {
    ...
    if (syntheticPackageActivated ||
        !Directory(path.join(_rootDirPath, _flutterAutoGeneratedOutputDir))
            .existsSync()) {
      Utils.writeLn("Using synthetic package for generated localizations. Consider migrating away foom synthetic package as it is deprecated by Flutter.");
